...
export default function App() {
  ...
  const renderView = () => {
    switch(view) {
      ...
      default: return (
        <div className="flex flex-col items-center gap-10 animate-fade-in max-w-6xl mx-auto pb-12">
          <header className="text-center mb-4 relative w-full flex flex-col items-center">
            
            {/* Title & Logo Section */}
            <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6">
              <div className="animate-bounce-short drop-shadow-xl">
                 <RobikiLogo className="w-24 h-24 md:w-32 md:h-32" />
              </div>
              <h1 className="text-5xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B6B] via-[#4ECDC4] to-[#A29BFE] drop-shadow-sm p-4 tracking-tight" style={{WebkitTextStroke: '2px white'}}>
                Phân Số Diệu Kì
              </h1>
            </div>

            {/* Author Info - Moved here as single line */}
            <div className="font-bold text-slate-600 text-base md:text-xl mt-2 bg-white/50 px-6 py-2 rounded-full backdrop-blur-sm border-2 border-white shadow-sm flex flex-col md:flex-row items-center gap-1 md:gap-3 animate-fade-in">
            ...
            <p className="text-slate-500 text-2xl font-bold mt-6 tracking-wide uppercase">Khám phá thế giới phân số</p>
          </header>
  ...
  return (
    <div className="min-h-screen font-sans text-slate-800 p-4 md:p-8 relative selection:bg-pink-200">
      <Background />
      ...
      <main className="container mx-auto mt-20 md:mt-8">
        {renderView()}
      </main>
